  ...
  <div className='flex sm:flex-col overflow-x-auto sm:overflow-y-scroll justify-between sm:justify-normal sm:w-[18.7%] w-full'>
    {
      productData.image.map((item,index)=>(
        <img onClick={()=>setImage(item)} src={item} key={index} className='w-[24%] sm:w-full sm:m-full flex-shrink-0 cursor-pointer ' alt="" />
      ))
    }
    ...
    <img className='w-full h-auto' src={image} alt="" />
      ...
      <div className='mt-20'>
        ...
        <div className='flex flex-col gap-4 border py-6 text-sm text-gray-500'>
          <p>Historically, surnames evolved as a way to sort people into groups - by occupation, place of origin, clan affiliation, </p>
           <p>Historically, surnames evolved as a way to sort people into groups - by occupation, place of origin, clan affiliation, </p>
        </div>
